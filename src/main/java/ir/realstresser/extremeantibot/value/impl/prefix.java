...
@ValueInformation(CategoryName = "General", name = "prefix", DefaultValBool = false, DefaultValStr = "[ExtreneAntiBot]", DefaultValInt = 0)
public class prefix extends ValueHandler {
    public prefix(){
        super("");
    }
}
